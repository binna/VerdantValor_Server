...
//     {
//         var request = new AuthenticationReq { Email = "",  Nickname = "", Pw = "" };
...
//         
//         request = new AuthenticationReq { Email = "banana1",  Nickname = "", Pw = "" };
...
//         Assert.False(response.IsSuccess, $"[{response.Code}] {response.Message}");
//         
//         request = new AuthenticationReq { Email = "banana1",  Nickname = "", Pw = "1234" };
//         response = await mUsersController.Join(request);
//         
//         mOutput.WriteLine($"{response.IsSuccess}");
//         mOutput.WriteLine($"{response.Code}");
...
//         Assert.False(response.IsSuccess, $"[{response.Code}] {response.Message}");
//         
//         request = new AuthenticationReq { Email = "banana1",  Nickname = "banana1", Pw = "1234" };
//         response = await mUsersController.Join(request);
//         
//         mOutput.WriteLine($"{response.IsSuccess}");
//         mOutput.WriteLine($"{response.Code}");
